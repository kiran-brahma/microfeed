...
export async function onRequestGet({params, env, request}) {
  ...
  const html = renderReactToHtml(<PodcastEpisodePage item={resolved.item} canonicalUrl={canonicalUrl} channel={resolved.channel} navTypes={resolved.navTypes} seo={resolved.seo} />);
